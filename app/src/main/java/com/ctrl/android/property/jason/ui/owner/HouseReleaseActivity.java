...
import com.ctrl.android.property.jason.ui.Fragment.HouseReleaseRentFragment;
...
public class HouseReleaseActivity extends AppToolBarActivity implements View.OnClickListener {
    ...
    private String TITLE= StrConstant.HOUSE_RELEASE;
    ...
    private void init() {
        ...
        HouseReleaseRentFragment fragment01= HouseReleaseRentFragment.newInstance();
        HouseReleaseRentFragment fragment02= HouseReleaseRentFragment.newInstance();
    ...
    public boolean setupToolBarRightButton(ImageView rightButton) {
        ...
        rightButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(HouseReleaseActivity.this,HouseTradingActivity.class);
