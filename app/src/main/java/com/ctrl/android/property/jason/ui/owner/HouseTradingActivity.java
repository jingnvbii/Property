...
import com.ctrl.android.property.jason.ui.Fragment.HouseTradingRentFragment;
...
public class HouseTradingActivity extends AppToolBarActivity implements View.OnClickListener {
    ...
    private String TITLE= StrConstant.HOUSE_TRADING;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_house_trading);
        init();
    }
    ...
    private void init() {
        ...
        HouseTradingRentFragment fragment01= HouseTradingRentFragment.newInstance(StrConstant.HOUSE_TRADING_RENT);
        HouseTradingRentFragment fragment02= HouseTradingRentFragment.newInstance(StrConstant.HOUSE_TRADING_SELL);
    ...
    public boolean setupToolBarRightButton(ImageView rightButton) {
        ...
        rightButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(HouseTradingActivity.this,BuyReleaseActivity.class);
