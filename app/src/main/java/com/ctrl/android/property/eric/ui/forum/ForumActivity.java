...
import com.ctrl.android.property.eric.ui.adapter.ForumCategaryAdapter;
...
public class ForumActivity extends AppToolBarActivity implements View.OnClickListener{
    ...
    private String communityId = AppHolder.getInstance().getCommunity().getId();//社区id 具体问题具体分析
