package com.ctrl.forum.service;
 ...
 */
    public class UpdateService extends Service {
        ...
        public int onStartCommand(Intent intent,int flags,int startId){
            ...
            PendingIntent contentIntent=PendingIntent.getActivity(this,0,new Intent(this,MyApplication.class),0);
            ...
            new Thread() {
                public void run(){
                    try {
                        ...
                        if (is != null) {
                            File rootFile=new File(Environment.getExternalStorageDirectory(), "/lzr");
                            if(!rootFile.exists()&&!rootFile.isDirectory())
                                rootFile.mkdir();

                            tempFile = new File(Environment.getExternalStorageDirectory(),

                                    "/lzr/"+url.substring(url.lastIndexOf("/")+1));
                            if(tempFile.exists())
                                tempFile.delete();
                ...
                if(msg!=null){
                    switch(msg.what){
                        ...
                        case 3:
                            ...
                            //更新状态栏上的下载进度信息
                            views.setTextViewText(R.id.progressBar,"已下载"+download_precent+"%");
                            views.setProgressBar(R.id.tv_download_length,100,download_precent,false);
                            notification.contentView=views;
                            nm.notify(notificationId,notification);
                            break;
                        case 4:
