 ...
 */
public class InvitationDetailReplyAdapter extends BaseAdapter {
    private int type;
    ...
    public InvitationDetailReplyAdapter(Context context,int type) {
   ...
   /* public void setSoundrUrl(String soundUrl) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mcontext).inflate(R.layout.item_listview_invitation_detail_reply, parent, false);
        ...
        holder.iv_reply_pinglun.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(type== Constant.FROM_APP) {
                    InvitationPinterestDetailActivity activity01 = (InvitationPinterestDetailActivity) mcontext;
                    activity01.replyPinglun(position);
                }
                if(type== Constant.FROM_PLATFORM) {
                    InvitationDetailFromPlatformActivity activity = (InvitationDetailFromPlatformActivity) mcontext;
    ...
    static class ViewHolder {
        ...
        @InjectView(R.id.iv_reply_pinglun)//回复
                ImageView iv_reply_pinglun;
