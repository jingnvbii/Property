 ...
 */
public class InvitationCommentDetailAdapter extends BaseAdapter {
    ...
    public InvitationCommentDetailAdapter(Context context) {
   ...
   /* public void setSoundrUrl(String soundUrl) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mcontext).inflate(R.layout.item_invitation_comment_detail, parent, false);
      ...
      //  holder.tv_reply_time.setText(TimeUtils.timeFormat(Long.parseLong(mPostReply2.getCreateTime()),"yyyy-MM-dd"));
            ...
            if (mPostReply2.getContentType().equals("0")) {//回复文字
                ...
                holder.rl_reply_voice.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        InvitationCommentDetaioActivity activity = (InvitationCommentDetaioActivity) mcontext;
        ...
        if (mPostReply2.getReplyType().equals("1")) {//有评论
            ...
            if (mPostReply2.getContentType().equals("0") && mPostReply2.getPreContentType().equals("0")) {//回复与评论都是文字
              ...
              //  holder.tv_reply_content.setText(mPostReply2.getReplyContent());
                ...
                holder.tv_pinglun_title.setText("引用  " + mPostReply2.getReceiverName() + "  的回复");
                SpannableString spannableString = FaceConversionUtil.getInstace().getExpressionString(mcontext, mPostReply2.getPreContent());
                holder.tv_pinglun_content.setText(spannableString);
                holder.tv_pinglun_floor.setText(mPostReply2.getReceiverFloor() + "楼");
        ...
        holder.tv_comment_detail_reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //
                InvitationCommentDetaioActivity activity=(InvitationCommentDetaioActivity)mcontext;
