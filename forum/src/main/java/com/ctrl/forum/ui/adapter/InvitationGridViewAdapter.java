...
public class InvitationGridViewAdapter extends BaseAdapter{
    ...
    private List<PostKind>kindList;

    public InvitationGridViewAdapter(Context context) {
               this.mcontext=context;
    }

    public void setList(List<PostKind> list) {
        this.kindList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        PostKind kind=kindList.get(position);
