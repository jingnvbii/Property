...
import com.ctrl.forum.cart.recycler.DividerItemDecoration;
import com.ctrl.forum.cart.recycler.RecyclerViewContentAdapter;
import com.ctrl.forum.cart.recycler.RecyclerViewMenuAdapter;
    ...
    private void setContentCommonadapter() {
        ...
        mRecyclerViewContentCommonadapter.setOnItemClickListener(new RecyclerViewContentAdapter.OnItemClickListener() {
            ...
            public void onItemJiaClick(RecyclerViewContentAdapter.ViewHolder holder) {
                ...
                /** 动画 */
                GoodsAnimUtil.setAnim(StoreShopListVerticalStyleActivity.this, holder.mImgJia, mCarLay);
