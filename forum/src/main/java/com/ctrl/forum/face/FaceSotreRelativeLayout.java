 ...
 ******************************************
 */
public class FaceSotreRelativeLayout extends RelativeLayout implements
	...
	public FaceSotreRelativeLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	}

	public FaceSotreRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	public void onClick(View v) {
		...
		case R.id.tv_photo_album://相册
			if(Arad.preferences.getBoolean("isFromStoreComment")){
		...
		case R.id.tv_photo_graph://拍照
			if(Arad.preferences.getBoolean("isFromStoreComment")){
				...
				RimStoreCommentActivity activity2 = (RimStoreCommentActivity) context;
				activity2.goToGraph();
			}else {
				RimStoreCommentActivity activity2=(RimStoreCommentActivity)context;
				activity2.goToGraph();
	...
	private void Init_View() {
		...
		iv_input_add = (ImageView) findViewById(R.id.iv_input_add);
