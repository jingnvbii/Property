...
public class Constant {
    ...
    /**服务地址 根路径 的配置 - Eric - */
    //public static final String RAW_URL = "http://121.42.159.145:8888/pm/api?";//外网地址
    //public static final String RAW_URL = "http://192.168.1.36:8088/pm/api?";//李鑫测试地址
    //public static final String RAW_URL = "http://192.168.1.119:8088/yfpm/api?";//桑越测试地址
    //public static final String RAW_URL = "http://192.168.1.217:8088/pm/api?";//方文测试地址
      public static final String RAW_URL = "http://114.215.95.182:8088/yfpm/api?";//客户地址
    // public static final String RAW_URL = "http://114.215.95.182:8077/pmpro/api?";//开创地址
