 ...
 */
public class CPatrolAdapter extends BaseAdapter {
    private Activity mActivity;
    private CPatrolFragment CPatrolFragment;
    private List<PatrolRoute> mData;

    public CPatrolAdapter(Activity activity, CPatrolFragment fragment) {
        mActivity = activity;
        this.CPatrolFragment = fragment;
    }
